...
declare const ExportKeysPayloadSchema: {
    request: z.ZodObject<{
        authData: z.ZodObject<{
            jwt: z.ZodString;
            apiKey: z.ZodString;
        ...
        data: z.ZodObject<{
            keyTypes: z.ZodDefault<z.ZodArray<z.ZodEnum<["secp256k1", "ed25519"]>, "many">>;
        }, "strip", z.ZodTypeAny, {
            keyTypes: ("secp256k1" | "ed25519")[];
        }, {
            keyTypes?: ("secp256k1" | "ed25519")[] | undefined;
        }>;
    }, "strip", z.ZodTypeAny, {
        authData: {
            jwt: string;
...
export { CompleteOnboardingPayloadSchema, type Encoding, ExportKeysPayloadSchema, GetAttestationPayloadSchema, GetPublicKeyPayloadSchema, GetStatusPayloadSchema, KEY_ENCODINGS, KEY_TYPES, type KeyType, SignPayloadSchema, StartOnboardingPayloadSchema };
