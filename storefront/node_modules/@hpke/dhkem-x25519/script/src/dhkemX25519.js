(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "@hpke/common", "./primitives/x25519.js", "./hkdfSha256.js"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.DhkemX25519HkdfSha256 = exports.X25519 = void 0;
    const common_1 = require("@hpke/common");
    const x25519_js_1 = require("./primitives/x25519.js");
    const hkdfSha256_js_1 = require("./hkdfSha256.js");
    class X25519 extends common_1.XCurveDhkemPrimitives {
        constructor(hkdf) {
            super("X25519", 32, x25519_js_1.x25519, hkdf);
        }
        derive(sk, pk) {
            try {
                ...
                return Promise.reject(new common_1.SerializeError(e));
            }
        }
    }
    ...
    class DhkemX25519HkdfSha256 extends common_1.Dhkem {
        constructor() {
            ...
            super(common_1.KemId.DhkemX25519HkdfSha256, new X25519(kdf), kdf);
